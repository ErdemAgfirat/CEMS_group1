...
![Periodic repetition of the spectrum](figures/periodic_spectrum.png){#fig-Periodic-repetition-of-the-spectrum}
...
![Reconstruction by filtering with a low-pass filter](figures/reconstruction.png){#fig-Reconstruction-by-filtering-with-a-low-pass-filter}
...
![Reconstruction of a sampled signal using sinc interpolation](figures/sinc_interpolation.png){#Reconstruction-of-a-sampled-signal-using-sinc-interpolation}
...
![Quantization characteristic [@goldenbaum2022grundlagen]](figures/quantization_characteristic.drawio.svg){#fig-Quantization-characteristic width=60%}
